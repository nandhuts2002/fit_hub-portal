                  ...
                  <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-xl">
                    <label className="flex items-start space-x-3 cursor-pointer">
                      ...
                      <div className="flex-1">
                        <span className="text-sm font-medium text-gray-900">Save this address for future orders</span>
                        <p className="text-xs text-gray-600 mt-1">We'll save this address to make your next checkout faster</p>
                      </div>
                    </label>
                    {saveCurrent && (
                      <div className="mt-3">
