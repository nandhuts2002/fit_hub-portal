        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex space-x-2 sm:space-x-4 md:space-x-8 overflow-x-auto">
            ...
            <button
              ...
              className="py-3 px-3 md:px-4 border-b-2 font-medium text-sm transition border-transparent text-slate-600 hover:text-slate-900 hover:border-slate-300"
            >
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    ...
                    strokeWidth={2}
                    d="M3 9l4-2 4 2 4-2 4 2v6l-4 2-4-2-4 2-4-2V9z"
                  />
                </svg>
